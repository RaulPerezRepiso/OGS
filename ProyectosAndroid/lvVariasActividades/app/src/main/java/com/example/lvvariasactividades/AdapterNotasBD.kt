...
class AdapterNotasBD {


    class AdapterAlumnDB(context: Context?, cursor: Cursor?) :
        CursorAdapter(context, cursor, 0) {
        // The newView method is used to inflate a new view and return it,
        // you don't bind any data to the view at this point.
        override fun newView(context: Context?, cursor: Cursor?, parent: ViewGroup?): View {
            return LayoutInflater.from(context).inflate(R.layout.layout_alumnos, parent, false)
        }
        ...
        override fun bindView(view: View, context: Context?, cursor: Cursor) {
            ...
            val tv_id = view.findViewById<TextView>(R.id.tvid_alumno)
            ...
            tvNota.setText( cursor.getInt(3))
